    ...
    switch (msg)
    {
        ...
        case WM_RBUTTONDOWN:
            ...
            else if(type==10)  //call Filling_Square    fundtion
            {
                ...
                alldata += "Filling_Square,"+ to_string(p[0][0])+ "," + to_string(p[0][1])+ ","+ to_string(sideLen) +"," + to_string(c) + "\n";
            }
            else if(type==11)  //call Filling_Rectangle    fundtion
            {
                ...
                alldata += "Filling_Rectangle," + to_string(p[0][0])+ "," + to_string(p[0][1])+ ","+ to_string(width) + "," + to_string(height) +"," + to_string(c) + "\n";
            }
